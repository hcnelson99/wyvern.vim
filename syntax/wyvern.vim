...
syn keyword wyvKeyword import var val new resource this delegate to require metadata module comprises extends if then elif else objtype as instantiate tagged match default case of effect recur
